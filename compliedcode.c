//basically here can I do left right for prev and next
//change foodname to itemname
//change totalsales to sales
//change flag to basecount
//change quantity to amount
//change price to costprice
//total_price to fullprice
//change data to entry
//change newnode to n_node

//change heada to head_1
//change headc to head_3
//change tailc to tail_3
//change taila to tail_1

//createadmin to theadministrators
//createcustomer thecustomer
//mainmenu to originalmenu
//adminmenu administratorsection
//customermenu customersection
